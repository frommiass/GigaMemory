...
from ...rag.questions.classifier import QuestionClassifier
from ...rag.questions.confidence import calculate_confidence_with_threshold
# from .keyword_matcher import KeywordMatcher  # Убираем циклический импорт
...
class RelevanceFilter:
    ...
    def __init__(self, config=None):
        ...
        # self.keyword_matcher = KeywordMatcher()  # Убираем из-за циклического импорта
