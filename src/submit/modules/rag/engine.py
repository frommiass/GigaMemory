...
from ..storage.filters.relevance_filter import RelevanceFilter
from ..storage.filters.session_grouper import SessionGrouper, extract_session_content
# from ..storage.message_filter import MessageFilter  # Убираем циклический импорт
# from .ranking.session_ranker import SessionRanker  # Убираем несуществующий модуль
...
class RAGEngine:
    ...
    def __init__(self, config=None):
        ...
        # self.session_ranker = SessionRanker(config)  # Убираем из-за отсутствующего модуля
        # self.message_filter = MessageFilter()  # Убираем из-за циклического импорта
