...
# from .improved_vector_search import ImprovedEmbeddingEngine, EmbeddingConfig, PoolingStrategy  # Убираем несуществующий модуль
...
# )  # Убираем несуществующий модуль
# from .vector_utils import benchmark_performance, compare_models, stress_test, optimize_store_config  # Убираем несуществующий модуль
